...
<body>
  ...
  <form id="userForm" method="post" action="<?php echo $_SERVER['PHP_SELF'] . '?id=' . $id; ?>">
    ...
    <input type="text" class="cad" name="id" value="<?php echo $id; ?>" readonly>
    <label for="username">Usuário:</label>
    <input type="text" class="cad" name="username" value="<?php echo $username; ?>" autofocus required>
    <label for="nome">Nome:</label>
    <input type="text" class="cad" name="nome" value="<?php echo $nome; ?>" required>
    <label for="sobrenome">Sobrenome:</label>
    <input type="text" class="cad" name="sobrenome" value="<?php echo $sobrenome; ?>" required>
    <label for="idade">Idade:</label>
    <input type="text" class="cad" name="idade" value="<?php echo $idade; ?>" required>
    <label for="telefone">Telefone:</label>
    <input type="text" class="cad" name="telefone" value="<?php echo $telefone; ?>" required>
    <label for="email">Email:</label>
    <input type="text" class="cad" name="email" value="<?php echo $email; ?>" required>
